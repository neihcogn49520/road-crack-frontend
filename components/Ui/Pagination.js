export default function Pagination({ pageSize, page, totalCount, onPageSizeChange, onPageChange }) {
  ...
  return (
    <div className="flex items-center justify-between bottom-0 bg-white py-2">
      <div className="text-xs text-slate-500 float-left ">
        <span>
          Hiển thị {fromNumber} đến {toNumber} của {totalCount} kết quả{" "}
        </span>
      </div>
      <div className=" float-right flex space-x-4">
        ...
        <div className="text-sm text-slate-500">
          <select
            className="border border-slate-500 py-2 px-1 rounded-md text-xs"
            value={pageSize}
          ...
          <nav aria-label="Page navigation example">
            <ul className="inline-flex items-center -space-x-px text-xs">
              <li>
                <a
                  href="#"
                  className="block py-2 px-3 ml-0 leading-tight text-gray-500 bg-white rounded-l-md border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                >
              ...
              <li>
                <a
                  href="#"
                  className="block py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-md border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                >
