  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="bg-white-blue-100 grid grid-cols-2 rounded-2xl shadow-lg max-w-4xl h-full p-5 items-center">
        ...
        >
          <div className="image-container md:block hidden w-full p-4">
            <Image src="/roadbg.png" alt="signup-image" width={400} height={600} className="align-middle rounded-2xl" />
          </div>
        </Transition>
        <Transition
          show={true}
        ...
        >
          ...
          <div className="form-container md:w-full p-2">
            <h2 className=" font-bold text-3xl text-deep-blue">Đăng ký</h2>
            <p className="text-sm mt-4 text-[#ffb703] font-semibold text-y">
              Đăng ký tài khoản với Road Crack để cập nhật và phản ánh các cơ sở hạ tầng hư hỏng!
            </p>
            <form action="" className="flex flex-col gap-4 mt-8">
              ...
              <div className=" relative ">
                <PasswordInput placeholder="Xác nhận mật khẩu" className="w-full p-2 border-slate-400" />
              </div>
              <button
                type="submit"
                className="transition duration-300 ease-out p-2 bg-navy-blue-400 text-white rounded-md hover:bg-navy-blue-200 md:ease-in"
              >
                Đăng ký
              </button>
            </form>
            ...
            <div className="mt-3 text-xs flex justify-between items-center">
              ...
              <Link href="/login" className="py-2 px-5 bg-white border rounded-xl hover:bg-white-blue-30">
                <div> Đăng nhập </div>
              </Link>
            </div>
          </div>
