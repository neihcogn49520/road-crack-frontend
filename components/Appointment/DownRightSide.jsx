    ...
    <div className="lg:w-1/3 lg:pl-8 mt-4 lg:mt-0 p-4">
      <div className="contact-box-layout1">
        ...
        <div className="flex items-center">
          <p className="inline mr-1 text-base md:text-lg opacity-100 font-semibold">Call us on </p>
          <h6 className="text-lg inline md:text-xl text-main-main">+91 00000 00000</h6>
        </div>
      </div>
    </div>
  );
