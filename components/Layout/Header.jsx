        ...
        <nav className="border-b-2 border-text-main/5 h-[60px] lg:h-[70px] w-full flex flex-col justify-center items-center bg-background-paper">
          <div className="max-w-[1140px] flex w-full flex-grow items-center px-4">
            ...
            <div className="flex justify-between w-full md:w-auto flex-grow md:flex-grow-0 items-center transition-all">
              ...
              >
                <Image width={500} height={500} src="/logo.png" className="rounded-[50%] w-[45px] h-[45px]"/>
                Med Experts
              </div>
            </div>
                    ...
                    >
                      ...
                      >
                        {name}
                            ...
                            <button type="button" onClick={themeToggle} className={` outline-none font-medium rounded-lg text-sm p-1 px-1.5 m-1 md:px-4 md:py-2 flex `}>{theme == "light" ? <HiOutlineMoon className='w-5 h-5 dark:text-white  dark:hover:bg-white/5' /> : <HiOutlineSun className='w-5 h-5 stroke-[2.25px]' />}</button>
