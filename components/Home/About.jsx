        ...
        <div className="w-full md:max-w-[33.33%] pt-8">
          <div className="pl-4 mt-4 mt-lg-0">
            ...
            <p className="mt-4 mb-8">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit, dolores at corporis non quas, aperiam ullam cum, perspiciatis nostrum asperiores delectus ea sunt repellat minima enim animi. Et illo facilis at eaque.<strong>YOU MUST TRY IT ONCE</strong>
            </p>
